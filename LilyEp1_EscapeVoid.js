...
lib.ssMetadata = [
		{name:"LilyEp1_EscapeVoid_atlas_1", frames: [[975,603,392,388],[0,722,973,199],[842,0,973,199],[842,201,973,199],[842,603,98,46],[842,402,973,199],[0,923,973,199],[0,0,840,720]]}
];
...
if (reversed == null) { reversed = false; }
	...
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {impload:72,impscene:73,titlestart:0};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);

	this.actionFrames = [0,71,72,143];
	// timeline functions:
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(71).call(this.frame_71).wait(1).call(this.frame_72).wait(71).call(this.frame_143).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.titlebtns).wait(71).to({_off:true},1).wait(72));
	...
	this.instance_3.setTransform(0,0,0.4949,0.6615);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.text}]}).to({state:[]},72).wait(72));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(512,208.1,513,745.1999999999999);
// library properties:
lib.properties = {
